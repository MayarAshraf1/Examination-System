...
namespace McqExaminationSystem.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            return userDtosManager.InsertEntityUsingDto(userDto) ? Ok("Successful Insertion!") : BadRequest();
        }

        [HttpPost("update")]
        public IActionResult Update(UserDto userDto)
        {
            return userDtosManager.UpdateEntityUsingDto(userDto) ? Ok("Successful Update!") : BadRequest();
        }

        [HttpDelete("delete/{userId}")]
        public IActionResult Delete(int userId)
        {
            return userDtosManager.DeleteEntity(userId) ? Ok("Successful Deletion Process!") : BadRequest();    
        }
    }
}
